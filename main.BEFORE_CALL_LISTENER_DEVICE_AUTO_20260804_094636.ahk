...
IniRead, callListenDevice, RkConfig.ini, CallListen, Device, 30
...
OpenSettings:
    ...
    Gui, Settings:Add, Text, xs y+6 w150 h22 +0x200, Аудіо-пристрій:
...
ShowCallProgress:
    ...
    Gui, CallGui:Add, Button, x10 y+6 w260 h28 gCallListenTest, 🎧 Тест слуху до тиші
...
CallListenTest:
    ToolTip, 🎧 Слухаю до тиші з аудіо-пристрою %callListenDevice%..., 10, 10, 6
    _listenCmd := ComSpec . " /c cd /d """ . A_ScriptDir . """ && python ""tools\call_listener\call_listen.py"" --device " . callListenDevice . " --model small --language auto --beam-size 3 --until-silence --seconds 8 --start-timeout 4 --min-speech-seconds 1.5 --silence-seconds 1.0 --rms-threshold 120"
