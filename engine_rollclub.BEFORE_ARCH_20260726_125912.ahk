...
RcDiagnosePointTest:
    ...
    _diagRes := RhGet("/api/iiko/read_point_after_find", 20000)
    FileAppend, % "[" A_Now "] READ_POINT_AFTER_FIND: " _diagRes "`n", %A_ScriptDir%\siv_debug.log
    ...
    if (InStr(_diagRes, "unknown_popup")) {
        ...
        ToolTip, % "Точка: " pointStr "`nPopup: " popupsCount "`nЧас: " elapsedMs " ms"
    }
    SetTimer, RemoveToolTip, -5000
return
; --------------------------------------------
