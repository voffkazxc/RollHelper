...
- виправлено читання номера, оператора, статусу та коментаря зі знайденого рядка
- F4 тепер переходить від швидкого пошуку до відкриття вільного замовлення
- після відкриття виконується стара робоча послідовність: читання, внесення, звук і зупинка чергування
- додано перевірку повного ланцюжка після захоплення замовлення
