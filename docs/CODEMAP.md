...
Текущий опубликованный релиз лаунчера: `0.1.15`.
Текущий пакет RollHouse в манифесте: `0.1.15`.
Текущее дополнение отчёта в манифесте: `rollhouse-report-load` версии `0.1.15`.
