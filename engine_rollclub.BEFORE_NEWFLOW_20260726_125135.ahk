...
^F12::
RcDiagnosePointTest:
    ToolTip, Запуск серверної діагностики точки...
    _diagRes := RhGet("/api/iiko/diagnose_point", 20000)
    FileAppend, % "[" A_Now "] DIAGNOSE_POINT_HOTKEY: " _diagRes "`n", %A_ScriptDir%\siv_debug.log
    ...
    ToolTip, % "Діагностика завершена. Точка: " diagServerPoint
    SetTimer, RemoveToolTip, -3000
return
; --------------------------------------------
